...
(function(window, $) {
    ...
    (function(cls) { // {{{
        ...
        cls.filter = function(list, query) {
            ...
            return _.filter(list, function(contact) { return contact.match(query.trim()); });
        };
        cls.itemContains = function(item, needle) {
            log.e('itemContains(', item, ', ', needle, ')');
        };
